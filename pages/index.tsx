  ...
  return (
    <>
      ...
      <div className="dashboard-container my-10 p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-lg text-center transition-colors duration-300 px-4">
        ...
        <div className="dashboard-role text-slate-500 dark:text-slate-300 mb-6">Peran: {currentUser.role === 'user' ? 'Pemilih' : currentUser.role === 'admin' ? 'Petugas' : currentUser.role}</div>
